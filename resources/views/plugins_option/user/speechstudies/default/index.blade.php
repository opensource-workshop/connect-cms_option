...
--}}
    ...
    <div>
        ...
        <div class="custom-control custom-radio custom-control-inline">
            <input type="radio" id="VoiceId1_{{$frame->id}}" name="VoiceId_{{$frame->id}}" class="custom-control-input" value="Mizuki" checked="checked">
            <label class="custom-control-label" for="VoiceId1_{{$frame->id}}">Mizuki</label>
        </div>
        <div class="custom-control custom-radio custom-control-inline">
            <input type="radio" id="VoiceId2_{{$frame->id}}" name="VoiceId_{{$frame->id}}" class="custom-control-input" value="Takumi">
